pipeline {
    ...
    post {  
		...
		slackSend color: "good", message: "${env.JOB_NAME} - ${env.BUILD_NUMBER} Build Success - ${env.BUILD_URL}/console"
        }
        ...
        unsuccessful {
                ...
                slackSend color: "danger", message: "${env.JOB_NAME} - ${env.BUILD_NUMBER} Build Failed - ${env.BUILD_URL}/console"
        }
    }
}
